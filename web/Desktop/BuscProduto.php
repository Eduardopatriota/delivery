...
<div class="container-fluid">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div>
                <button onclick="Acessar('Desktop/CadProduto.php', 'CadProduto')" type="button" class="btn btn-success">Cadastrar</button>
            </div>
                    ...
                    <tbody>
                        ...
                        while ($Linhas = mysqli_fetch_assoc($Result)) {
                            echo '<tr class="odd gradeX">
                                    ...
                                    <td>' . $Linhas['nome'] . '</td>
                                    <td>' . $Linhas['grupo'] . '</td>
                                    <td><a onclick="Acessar(\'Desktop/CadProduto.php?id=' . $Linhas['id'] . '\', \'CadProduto&id=' . $Linhas['id'] . '\')"><i class="fas fa-edit"></i> Editar</a></td>
                                  </tr>';
                        }
                        ?>
                    </tbody>
