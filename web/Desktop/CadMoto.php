...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Cadastro de motoboy</h1>
        </div>
    </div>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <button style="width: 100%; margin-top: 0.5em;" id="Excluir" onclick="Excluir('php/control/Motoboy/Excluir.php?Id=<?php echo $Id; ?>')" class="btn btn-danger" <?php echo $AbilitarBtExcluir; ?>>Excluir</button>
    ...
    <script type="text/javascript">
        ...
        jQuery.ajax({
                    type: "POST",
                    url: "php/control/Motoboy/Insert.php",
                    data: dados,
                    beforeSend: function () {
